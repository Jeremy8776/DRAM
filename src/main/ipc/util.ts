...
export function registerUtilHandlers(ipc, secureStorage, windowManager, debugLog) {
     ...
     */
    async function internalRequest(method, params: any = {}, timeout = REQUEST_TIMEOUT, options: any = {}): Promise<any> {
    ...
    ipc.handle('util:transcribeAudio', async (_event, audioBase64, options: any = {}) => {
        try {
