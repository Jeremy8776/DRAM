  ...
  async function initialize() {
    try {
      ...
      app.on('web-contents-created', (_event, contents) => {
        ...
        contents.session.setPermissionRequestHandler((webContents, permission, callback, details: any) => {
        ...
        contents.session.setPermissionCheckHandler((webContents, permission, requestingOrigin, details: any) => {
