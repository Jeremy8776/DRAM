...
import { wizardState, getProviderFromModel, validateApiKey, finishWizardCore, finishWizardIntegrations, initializeWizardState, collectPluginConfigsFromDOM } from './wizard.js';
        ...
        const updateWizardUI = async () => {
            ...
            if (state.connected) {
                ...
                if (waitTime > maxWaitTime) {
                    ...
                    import('./socket.js').then(({ connect }) => connect().catch(() => { }));
                    waitTime = 0;
                } else {
